...
{
    public class LeitorRetornoCnab240Sicoob : ILeitorArquivoRetornoCnab240
    {
       private readonly List<string> _linhasArquivo;

       public LeitorRetornoCnab240Sicoob(List<string> linhasArquivo)
        {
        ...
        public HeaderRetornoCnab240 ObterHeader(string linhaObterInformacoes)
        {
            ...
            objRetornar.CodigoCedente = linha.ExtrairValorDaLinha(59, 70).BoletoBrToInt();
        ...
        public HeaderLoteRetornoCnab240 ObterHeaderLote(string linhaObterInformacoes)
        {
            ...
            objRetornar.CodigoCedente = linha.ExtrairValorDaLinha(60, 71).BoletoBrToInt();
        ...
        public DetalheSegmentoTRetornoCnab240 ObterRegistrosDetalheT(string linhaProcessar)
        {
            ...
            objRetornar.CodigoCedente = linha.ExtrairValorDaLinha(24, 35).BoletoBrToInt();
        ...
        public DetalheSegmentoURetornoCnab240 ObterRegistrosDetalheU(string linhaProcessar)
        {
          ...
          objRetornar.CodigoSacadoNoBanco = linha.ExtrairValorDaLinha(154, 157);
          objRetornar.ValorPagoPeloSacado = linha.ExtrairValorDaLinha(166,180).BoletoBrToDecimal() / 100;
