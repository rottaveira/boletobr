...
{
    public class EscritorRemessaPagamentoCnab240BancoDoBrasil : IEscritorArquivoRemessaCnab240
    {
        private readonly RemessaCnab240 _remessaEscrever;

        public EscritorRemessaPagamentoCnab240BancoDoBrasil(RemessaCnab240 remessaEscrever)
        {
        ...
        public string EscreverHeader(HeaderRemessaCnab240 infoHeader)
        {
            ...
            try
            {
                var teste = infoHeader.Teste == null ? "TS" : infoHeader.Teste;

                header = header.PreencherValorNaLinha(1, 3, "001");
                ...
                header = header.PreencherValorNaLinha(33, 41, infoHeader.CodigoConvenio.PadRight(9, ' '));
                header = header.PreencherValorNaLinha(42, 45, "0126");
                header = header.PreencherValorNaLinha(46, 50, string.Empty.PadLeft(5, ' '));
                header = header.PreencherValorNaLinha(51, 52, teste.PadLeft(2, ' '));
                ...
                header = header.PreencherValorNaLinha(71, 71, infoHeader.DigitoContaCorrente.PadRight(1, '0').ToUpper());
                header = header.PreencherValorNaLinha(72, 72, "0");
                header = header.PreencherValorNaLinha(73, 102, nomeCedente.ToUpper().PadRight(30, ' '));
                header = header.PreencherValorNaLinha(103, 132, "BANCO DO BRASIL".PadRight(30, ' '));
                ...
                header = header.PreencherValorNaLinha(164, 166, "001");
                ...
                header = header.PreencherValorNaLinha(212, 225, string.Empty.PadRight(14, ' '));
                header = header.PreencherValorNaLinha(226, 240, string.Empty.PadRight(15, '0'));
        ...
        public string EscreverHeaderDeLote(HeaderLoteRemessaCnab240 infoHeaderLote, bool headerJ, bool boletoBB)
        {
            ...
            try
            {
                headerLote = headerLote.PreencherValorNaLinha(1, 3, "001"); // Código do Banco na Compensação
                ...
                */
                ...
                var formaLancamento = headerJ ? boletoBB ? "30" : "31" : infoHeaderLote.FormaDeLancamento.PadLeft(2, '0');

                var teste = infoHeaderLote.Teste == null ? "TS" : infoHeaderLote.Teste;
                headerLote = headerLote.PreencherValorNaLinha(10, 11, headerJ ? "98" : infoHeaderLote.TipoServico.PadLeft(2, '0')); // Tipo de Serviço
                headerLote = headerLote.PreencherValorNaLinha(12, 13, formaLancamento);  // Forma de lancamento
                headerLote = headerLote.PreencherValorNaLinha(14, 16, "001"); // Nº da versão do Layout do Lote
                ...
                headerLote = headerLote.PreencherValorNaLinha(33, 41, infoHeaderLote.Convenio.BoletoBrToStringSafe().PadLeft(9, '0'));
                headerLote = headerLote.PreencherValorNaLinha(42, 45, "0126");
                headerLote = headerLote.PreencherValorNaLinha(46, 50, string.Empty.PadLeft(5,' '));
                headerLote = headerLote.PreencherValorNaLinha(51, 52, teste.BoletoBrToStringSafe().PadRight(2, ' '));
                ...
                headerLote = headerLote.PreencherValorNaLinha(71, 71, infoHeaderLote.DigitoContaCorrente.BoletoBrToStringSafe().PadRight(1, '0').ToUpper());
                ...
                headerLote = headerLote.PreencherValorNaLinha(223, 230, string.Empty.PadRight(8, ' '));
                headerLote = headerLote.PreencherValorNaLinha(231, 240, string.Empty.PadRight(10, '0'));
        ...
        public string EscreverDetalheSegmentoA(DetalheSegmentoARemessaCnab240 infoSegmentoA)
        {
            ...
            try
            {
                segmentoA = segmentoA.PreencherValorNaLinha(1, 3, "001"); // Código do Banco na Compensação
                ...
                */
                ...
                segmentoA = segmentoA.PreencherValorNaLinha(231, 240, string.Empty.PadLeft(10, '0'));
        ...
        public string EscreverDetalheSegmentoB(DetalheSegmentoBRemessaCnab240 infoSegmentoB)
        {
            ...
            try
            {
                segmentoB = segmentoB.PreencherValorNaLinha(1, 3, "001");
        ...
        public string EscreverDetalheSegmentoJ(DetalheSegmentoJRemessaCnab240 infoSegmentoJ)
        {
            ...
            try
            {
                ...
                segmentoJ = segmentoJ.PreencherValorNaLinha(231, 240, "0000000000");
        ...
        public string EscreverTrailerDeLote(TrailerLoteRemessaCnab240 infoTrailerLote, decimal? totalPagamentoLote)
        {
            ...
            try
            {
                ...
                trailerLote = trailerLote.PreencherValorNaLinha(1, 3, "001");
                ...
                trailerLote = trailerLote.PreencherValorNaLinha(231, 240, "0000000000");
        ...
        private List<string> EscreverLote(LoteRemessaCnab240 loteEscrever)
        {
            ...
            if (segJ.Any(a => a.SegmentoJ != null))
            {
                ...
                if (segJ.Any(a => a.SegmentoJ.CodigoBancoFavorecido == "001"))
                {
                    LoteServico++;
                    loteEscrever.HeaderLote.LoteServico = LoteServico;
                    loteEscrever.TrailerLote.LoteServico = LoteServico;
                    listaRet.Add(EscreverHeaderDeLote(loteEscrever.HeaderLote, true, true));

                    foreach (var detalhe in segJ.Where(a => a.SegmentoJ.CodigoBancoFavorecido == "001"))
                    {
                        if (detalhe.SegmentoJ.LoteServico.BoletoBrToStringSafe().BoletoBrToInt() == 0)
                            detalhe.SegmentoJ.LoteServico = LoteServico;
                ...
                if (segJ.Any(a => a.SegmentoJ.CodigoBancoFavorecido != "001"))
                {
                    ...
                    loteEscrever.HeaderLote.LoteServico = LoteServico;
                    loteEscrever.TrailerLote.LoteServico = LoteServico;
                    listaRet.Add(EscreverHeaderDeLote(loteEscrever.HeaderLote, true, false));
