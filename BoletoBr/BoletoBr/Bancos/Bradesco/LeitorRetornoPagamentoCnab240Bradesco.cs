...
{
    public class LeitorRetornoPagamentoCnab240Bradesco : ILeitorArquivoRetornoCnab240
    {
        private readonly List<string> _linhasArquivo;

       public LeitorRetornoPagamentoCnab240Bradesco(List<string> linhasArquivo)
        {
        ...
        public HeaderRetornoCnab240 ObterHeader(string linha)
        {
            var objRetornar = new HeaderRetornoCnab240
            {
                ...
                NomeDoBanco = linha.ExtrairValorDaLinha(103, 142).Trim(),
        ...
        public DetalheSegmentoARetornoCnab240 ObterRegistrosDetalheA(string linha)
        {
            var objRetornar = new DetalheSegmentoARetornoCnab240
            {
                ...
                AgenciaMantenedoraFavorecido = linha.ExtrairValorDaLinha(24, 28),
                DigitoAgenciaMantenedoraFavorecido = linha.ExtrairValorDaLinha(29, 29),
                ContaFavorecido = linha.ExtrairValorDaLinha(30, 41).Trim(),
                DigitoContaFavorecido = linha.ExtrairValorDaLinha(42, 43),
