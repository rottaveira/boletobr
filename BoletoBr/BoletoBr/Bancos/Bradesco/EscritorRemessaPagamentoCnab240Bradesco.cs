...
{
    public class EscritorRemessaPagamentoCnab240Bradesco : IEscritorArquivoRemessaCnab240
    {
        private readonly RemessaCnab240 _remessaEscrever;
 
        public EscritorRemessaPagamentoCnab240Bradesco(RemessaCnab240 remessaEscrever)
        {
        ...
        public string EscreverHeader(HeaderRemessaCnab240 infoHeader)
        {
            ...
            try
            {
                var banco = Fabricas.BancoFactory.ObterBanco(infoHeader.CodigoBanco);
                ...
                header = header.PreencherValorNaLinha(71, 72,   infoHeader.DigitoContaCorrente.PadRight(2, ' '));
                header = header.PreencherValorNaLinha(73, 102,  nomeCedente.PadRight(30, '0').ToUpper());  
                header = header.PreencherValorNaLinha(103, 132, infoHeader.NomeBanco.ToUpper().PadRight(30, ' '));
                ...
                header = header.PreencherValorNaLinha(164, 166, "089");
        ...
        public string EscreverHeaderDeLote(HeaderLoteRemessaCnab240 infoHeaderLote, bool headerJ)
        {
            ...
            try
            {
                ...
                */
                ...
                headerLote = headerLote.PreencherValorNaLinha(10, 11, infoHeaderLote.TipoServico.ToString().PadLeft(2, '0')); // Tipo de Serviço
                headerLote = headerLote.PreencherValorNaLinha(12, 13, infoHeaderLote.FormaDeLancamento.PadLeft(2, '0'));  
                headerLote = headerJ ? headerLote.PreencherValorNaLinha(14, 16, "040") : headerLote.PreencherValorNaLinha(14, 16, "045"); // Nº da versão do Layout do Lote
                ...
                headerLote = headerLote.PreencherValorNaLinha(58, 58, infoHeaderLote.DigitoAgencia.BoletoBrToStringSafe());
                headerLote = headerLote.PreencherValorNaLinha(59, 70, infoHeaderLote.NumeroContaCorrente.BoletoBrToStringSafe().PadLeft(12,'0'));
                headerLote = headerLote.PreencherValorNaLinha(71, 72, infoHeaderLote.DigitoContaCorrente.BoletoBrToStringSafe().PadRight(2,' ')); 
                headerLote = headerLote.PreencherValorNaLinha(73, 102, nomeCedente.BoletoBrToStringSafe().PadRight(30, ' ').ToUpper());
                ...
                headerLote = headerLote.PreencherValorNaLinha(173, 177, infoHeaderLote.Numero.PadLeft(5, ' '));
                ...
                headerLote = headerLote.PreencherValorNaLinha(218, 220, infoHeaderLote.ComplementoCep.PadRight(3, ' ').ToUpper());
                ...
                {
                    headerLote = headerLote.PreencherValorNaLinha(223, 224, "01");
                    headerLote = headerLote.PreencherValorNaLinha(225, 230, string.Empty.PadRight(6, ' '));
                }
                  
                headerLote = headerLote.PreencherValorNaLinha(231,240, string.Empty.PadRight(10, ' '));  
        ...
        { 
            ...
            try
            {
                segmentoA = segmentoA.PreencherValorNaLinha(1, 3, infoSegmentoA.CodigoBanco.PadLeft(3, '0')); // Código do Banco na Compensação
                ...
                */
                ...
                segmentoA = segmentoA.PreencherValorNaLinha(230, 230, "6"); 
        ...
        { 
            ...
            try
            {
                segmentoB = segmentoB.PreencherValorNaLinha(1, 3, infoSegmentoB.CodigoBanco.PadLeft(3, '0'));
                ...
                segmentoB = segmentoB.PreencherValorNaLinha(63, 67, infoSegmentoB.NumeroFavorecido.PadLeft(5, '0').Substring(0, 5));
                ...
                segmentoB = segmentoB.PreencherValorNaLinha(226,226, "6");
                segmentoB = segmentoB.PreencherValorNaLinha(227,232, "000000");
                segmentoB = segmentoB.PreencherValorNaLinha(233,240, "00000000");
        ...
        public string EscreverTrailerDeLote(TrailerLoteRemessaCnab240 infoTrailerLote, decimal totais)
        {
            ...
            try
            {
                var somatoriaValores = string.Empty;
                #region valor
                if (totais.ToString("f").Contains('.') && totais.ToString("f").Contains(','))
                    somatoriaValores = totais.ToString("f").Replace(".", "").Replace(",", "");
                if (totais.ToString("f").Contains('.'))
                    somatoriaValores = totais.ToString("f").Replace(".", "");
                if (totais.ToString("f").Contains(','))
                    somatoriaValores = totais.ToString("f").Replace(",", "");
                #endregion 

                trailerLote = trailerLote.PreencherValorNaLinha(1, 3, "237");
                ...
                trailerLote = trailerLote.PreencherValorNaLinha(24, 41, somatoriaValores.PadLeft(18, '0'));
                trailerLote = trailerLote.PreencherValorNaLinha(42, 59, "000000000000000001");
                trailerLote = trailerLote.PreencherValorNaLinha(60, 65, string.Empty.PadLeft(6, ' '));
        ...
        public string EscreverTrailer(TrailerRemessaCnab240 infoTrailer)
        {
            ...
            try
            {
                trailer = trailer.PreencherValorNaLinha(1, 3, infoTrailer.CodigoBanco.ToString().PadLeft(3,'0'));
